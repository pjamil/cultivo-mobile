...
void main() {
  ...
  group('Ambientes Flow', () {
    testWidgets('List ambientes', (tester) async {
      app.main();
      await tester.pumpAndSettle();
      await _login(tester);
      await _navigateTo(tester, 'Ambientes');
      await tester.pumpAndSettle();
      expect(find.byType(ListView), findsWidgets);
    });

    testWidgets('View ambiente details', (tester) async {
      app.main();
      await tester.pumpAndSettle();
      await _login(tester);
      await _navigateTo(tester, 'Ambientes');
    ...
    testWidgets('Navigate to create ambiente form', (tester) async {
      app.main();
      await tester.pumpAndSettle();
      await _login(tester);
      await _navigateTo(tester, 'Ambientes');
      ...
      if (addButton.evaluate().isNotEmpty) {
        ...
        await tester.pumpAndSettle();
        expect(find.byKey(const Key('nome-input')), findsOneWidget);
      }
    });
  });
}
