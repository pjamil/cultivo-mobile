...
void main() {
  ...
  group('Diario Flow', () {
    testWidgets('List diarios', (tester) async {
      app.main();
      await tester.pumpAndSettle();
      await _login(tester);
      await _navigateTo(tester, 'Diário');
      await tester.pumpAndSettle();
      expect(find.byType(ListView), findsWidgets);
    });

    testWidgets('View diario details', (tester) async {
      app.main();
      await tester.pumpAndSettle();
      await _login(tester);
      await _navigateTo(tester, 'Diário');
    ...
    testWidgets('Navigate to create diario form', (tester) async {
      app.main();
      await tester.pumpAndSettle();
      await _login(tester);
      await _navigateTo(tester, 'Diário');
